...
from exam.models import User, Course
...
class Customer(models.Model):
    ...
    roles = models.ManyToManyField('Role', related_name='customers')
    customer_resources = models.ManyToManyField('CustomerResources', related_name='customers')
...
class CustomerResources(models.Model):
    resource = models.ForeignKey('Resources', on_delete=models.CASCADE, related_name='customer_resources')
